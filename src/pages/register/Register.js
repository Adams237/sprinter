        ...
        <section>
            ...
            <div className="py-16 md:py-24 lg:py-32">
                ...
                <div className="mx-auto max-w-xl bg-[#f2f2f7] px-5 py-12 text-center md:px-10">
                    ...
                    {/*<!-- Button -->*/}
                    <button className="mx-auto w-full flex max-w-sm justify-center bg-[#276ef1] px-8 py-4 text-center font-semibold text-white transition [box-shadow:rgb(171,_196,_245)_-8px_8px] hover:[box-shadow:rgb(171,_196,_245)_0px_0px]">
                    ...
                    <form className="mx-auto mb-4 max-w-sm pb-4" name="wf-form-password" method="get">
                        <div className="relative">
                            ...
                            <input type="email" className="mb-4 block h-9 w-full border border-black bg-white px-3 py-6 pl-14 text-sm text-[#333333]" name="name" placeholder="Email Address" required="" />
                        </div>
                        <div className="relative">
                        ...
                        <div className="relative">
                            ...
                            <input type="number" className="mb-4 block h-9 w-full border border-black bg-white px-3 py-6 pl-14 text-sm text-[#333333]" placeholder="entrer votre numéro de téléphone (min 8 characters)" required />
                        </div>
                        <div className="relative mb-4 pb-2">
                            <img alt="" src="https://assets.website-files.com/6357722e2a5f19121d37f84d/6357722e2a5f19601037f879_Lock-2.svg" className="absolute bottom-0 left-[5%] right-auto top-[26%] inline-block" />
                            <input type="text" className="mb-4 block h-9 w-full border border-black bg-white px-3 py-6 pl-14 text-sm text-[#333333]" placeholder="entrer votre numéro de votre cni" required />
                        </div>
                    ...
                    <p className="text-sm text-[#636262]">Avez vous déjà un compte? <Link to='/logiin' className="font-[Montserrat,_sans-serif] text-sm font-bold text-black">Login now</Link>
                    </p>
                </div>
            </div>
        </section>
